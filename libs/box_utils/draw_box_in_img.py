...
def draw_boxes_with_label_and_scores(img_array, boxes, labels, scores, method, head, in_graph=True):
    if in_graph:
    ...
    for box, a_label, a_score, a_head in zip(boxes, labels, scores, head):
        ...
        if a_label != NOT_DRAW_BOXES:
            ...
            if a_label == ONLY_DRAW_BOXES:  # -1
                ...
                draw_label_with_scores(draw_obj, box, a_label, a_score, method, a_head, color=STANDARD_COLORS[a_label])
