...
def anchor_target_layer(gt_boxes_h, gt_boxes_r, gthead_quadrant, gt_smooth_label, anchors, gpu_id=0):
    ...
    if gt_boxes_r.shape[0]:
        ...
        target_smooth_label = np.zeros((anchors.shape[0], cfgs.ANGLE_RANGE))
